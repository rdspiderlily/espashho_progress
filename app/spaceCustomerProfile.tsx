        ...
        <View style={styles.form}>
          ...
          <View style={styles.inputContainer}>
            ...
            <TouchableOpacity onPress={() => setPasswordVisible(!passwordVisible)}>
              <Ionicons name={passwordVisible ? "eye-outline" : "eye-off-outline"} size={20} color="#0988EE" />
            </TouchableOpacity>
          </View>

          {/* Trigger Save Modal */}
          <TouchableOpacity style={styles.confirmButton} onPress={() => setSaveModalVisible(true)}>
      ...
      <Modal animationType="fade" transparent={true} visible={saveModalVisible}>
        <View style={styles.modalOverlay}>
          <View style={styles.modalContent}>
            ...
            <Text style={styles.modalSubTitle}>Your information has been successfully updated.</Text>
            <TouchableOpacity 
      ...
      <Modal animationType="fade" transparent={true} visible={logoutModalVisible}>
        <View style={styles.modalOverlay}>
          <View style={styles.modalContent}>
            ...
            <Text style={styles.modalSubTitle}>Are you sure you want to logout? Any unsaved changes will be lost.</Text>
            <View style={styles.modalButtons}>
              ...
              <TouchableOpacity style={[styles.modalBtn, styles.logoutConfirmBtn]} onPress={() => { setLogoutModalVisible(false); router.replace('/'); }}>
